...
class Config(object):
    ...
    # Put MongoDB URL
    DATABASE_URL = get_config("DATABASE_URL", "mongodb+srv://unzipper:unzipper@cluster0.fc8uopr.mongodb.net/?retryWrites=true&w=majority")
    ...
    LOG_CHANNEL = get_config("LOG_CHANNEL", "-1001887884003")
    UPDATES_CHANNEL = get_config("UPDATES_CHANNEL", None) # Without `@` LOL
     # Get these values from my.telegram.org
    # array to store the channel ID who are authorized to use the bot
    AUTH_USERS =get_config("AUTH_USERS", "1022568191")
